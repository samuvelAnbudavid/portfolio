...
export class SkillsComponent implements OnInit {
  skills:any={
    technologies:[ {name:"PHP",percent:70,remark:'good'}, {name:"JavaScript, BootStrap, Angular", percent:90,remark:'excellent'},{name:"Node js(js,Typescript),Express js",percent:90,remark:'excellent'}],
